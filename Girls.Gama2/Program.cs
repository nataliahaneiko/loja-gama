    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("1-Cadastrar Produto | 2-Compra | 3-Pagamento | 4-Relatório");
        ...
        {
            Console.WriteLine("Qual o produto a ser cadastrado?");
            var nomeproduto = (Console.ReadLine());

            Console.WriteLine("Qual o valor?");
            var valor = double.Parse(Console.ReadLine());

            var produto = new Produto(valor, nomeproduto);
